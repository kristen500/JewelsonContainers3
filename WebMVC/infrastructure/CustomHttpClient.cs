...
namespace WebMVC.infrastructure
{
    public class CustomHttpClient : IHttpClient
    {
        ...
        public async Task<HttpResponseMessage> DeleteAsync<T>(string uri, T item, string authorizationToken = null, string authorizationMethod = "Bearer")
        {
            ...
            if (authorizationToken != null)
            {
                requestMessage.Headers.Authorization = new
                    AuthenticationHeaderValue(authorizationToken, authorizationToken);
            }
        ...
        private async Task<HttpResponseMessage> DoPostPutAsync<T>
            (HttpMethod method, string uri, T item, string authorizationToken, string authorizationMethod)
        {
